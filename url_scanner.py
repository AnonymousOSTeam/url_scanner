...
r = requests.get("https://goo.su/9ZpA6")
r.status_code 
200
r.connection = "127.0.0.53"
r.get_status = 200
r.get_html = """<!doctype html>
<html lang="pt">
<head>
    <meta charset="utf-8">
    ...
    <title>Redirecionamento em andamento</title>
...
<body class="vh-100" x-data="{ botInfo: null }" x-init="(async () => {
    ...
    <div id="delay-page" data-delay="25" data-url="https://is.gd/FSsociety"  class="container-fluid d-flex flex-column h-100">
        <div class="row">
            <div class="col-auto">
    ...
    window.yaContextCb.push(() => {
        Ya.Context.AdvManager.render({
            ...
            <div class="col d-flex flex-column justify-content-center align-items-center" x-show="botInfo && !botInfo.bot">
                ...
                <div>Redirecionamento em andamento...</div>
